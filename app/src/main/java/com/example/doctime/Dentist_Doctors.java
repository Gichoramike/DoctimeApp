...
public class Dentist_Doctors extends AppCompatActivity {
        ...
        nav_view.setOnItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.home_btn) {
                    intent = new Intent(Dentist_Doctors.this, HomeActivity.class);
                } else if (item.getItemId() == R.id.appointment_btn) {
                    intent = new Intent(Dentist_Doctors.this, Appointment.class);
                } else if (item.getItemId() == R.id.doctor_btn) {
                    intent = new Intent(Dentist_Doctors.this, DoctorActivity.class);
                } else if (item.getItemId() == R.id.profile_btn) {
                    intent = new Intent(Dentist_Doctors.this, Profile.class);
                }
                if (intent != null) {
